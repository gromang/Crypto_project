...
3. Затем происходит формирование параметров итоговой свечи/бара
  ...
  Допустим, для сокращения, примем следующие обозначения:
  ...
  * ob, oh и ok - цены открытия свечей, полученных соотвественно от Binance, HitBtc и Kraken
  ...
  Timestamp итоговой свечи дожно совпадать с timestamp получаемых свечей.
...
На данном моменте оптимальным выбором, видится sqlite.
